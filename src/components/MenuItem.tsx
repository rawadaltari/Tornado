          ...
          <div className="space-y-2">
            ...
            {item.available && (
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-xs text-white/85 font-medium">Popular</span>
              </div>
            )}
          </div>
        </div>
...
export function MenuPageLayout({ children, categoryName }: { children: React.ReactNode, categoryName: string }) {
  return (
